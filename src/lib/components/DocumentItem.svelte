...
<div class="w-full h-28 flex items-center justify-between">
  <div class="flex flex-col w-full ml-4 h-full justify-center">
    <a href="/documents/{document.id}" class="font-semibold text-lg"
      >{document.title}</a
    >
  </div>
  <div class="flex items-center justify-end w-full">
    <a href="/documents/{document.id}/edit" class="btn btn-outline"
      >Edit Document</a
    >
    <Modal label={document.id} checked={modalOpen}>
      ...
      <div slot="heading">
        ...
        <p class="text-base font-normal mt-2">
          Are you sure you want to delete this document? Once deleted, the
      ...
      >
        ...
        <form
          ...
          method="POST"
          use:enhance={submitDeleteDocument}
        >
