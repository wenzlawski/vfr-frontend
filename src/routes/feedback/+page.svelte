...
{#if !success}
  <div class="flex flex-col justify-center items-center mt-5 mx-2">
    <form method="POST" use:form>
      ...
      <label for="accuracy"
        >How accurate were the results provided by Readanalytics?</label
      >
      <RadioFeedback name="accuracy" values={[1, 2, 3, 4, 5]} />
      <br />
      <label for="usefulness"
        >How useful was Readanalytics in helping you understand the argument
        structure of the text?</label
      >
      <RadioFeedback name="usefulness" values={[1, 2, 3, 4, 5]} />
      <br />
      <label for="speed"
        >How fast was Readanalytics in generating results?</label
      >
      ...
      <label for="errors"
        >Did you experience any errors or bugs while using Readanalytics?</label
      >
...
{:else}
  <div class="flex flex-col justify-center items-center mt-5">
    ...
    <p>
      Click <a class="text-blue-500" href="/">here</a> to return to the home page.
    </p>
  </div>
{/if}
